...
* `us_states_misc_stats.csv` - 5KB - Data updated 2021-05-27 - Contains various statistics about all 50 states + DC, such as COVID-19 deaths per 100k, change in unemployment rates, population density, median age, etc.
